...
curl -s http://localhost:8082/api/productos >nul 2>&1
if %errorlevel% neq 0 (
...
echo ========================================
curl -X PATCH http://localhost:8082/api/productos/codigo/MART001/precio ^
  -H "Content-Type: application/json" ^
...
echo ========================================
curl -X PATCH http://localhost:8082/api/productos/999/precio ^
  -H "Content-Type: application/json" ^
...
echo ========================================
curl -X GET http://localhost:8082/api/productos/1/historial-precios
echo.
echo.
...
echo ========================================
curl -X PATCH http://localhost:8082/api/productos/3/precio ^
  -H "Content-Type: application/json" ^
