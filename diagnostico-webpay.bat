...
curl -X GET http://localhost:8082/api/test/webpay-simulation-status
echo.
echo.
...
curl -X POST http://localhost:8082/api/webpay-simulation/simulate/init -H "Content-Type: application/json" -d "{\"pedidoId\": 99999, \"monto\": 10000.0, \"metodoPago\": \"WEBPAY\"}"
echo.
echo.
...
curl -X GET http://localhost:8082/api/webpay-simulation/simulate/panel
echo.
echo.
