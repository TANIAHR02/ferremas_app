...
curl -s http://localhost:8081/api/banco-central/tasa-cambio > nul 2>&1
if %errorlevel% neq 0 (
    echo ERROR: La aplicacion no esta corriendo en puerto 8081
...
echo ===============================================
curl -s http://localhost:8081/api/banco-central/tasa-cambio
echo.
echo.
...
echo ===============================================
curl -s http://localhost:8081/api/banco-central/tasas-cambio
echo.
echo.
...
echo ===============================================
curl -s http://localhost:8081/api/banco-central/convertir-usd?montoUSD=100
echo.
echo.
...
echo ===============================================
curl -s http://localhost:8081/api/banco-central/convertir-eur?montoEUR=50
echo.
echo.
...
echo ===============================================
curl -s http://localhost:8081/api/banco-central/tasa-cambio/USD
echo.
echo.
